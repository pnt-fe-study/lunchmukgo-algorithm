...
### 문제 구성
- 매주 총 **2 ~ 3문제**
- 난이도는 주차별로 조절 (예: 쉬움 1 + 중간 2 / 또는 난이도 섞기)

### 제출/진행 마감
- **화요일 오후 12:00 전까지:** 1문제 풀이 PR 올리기
...
1. 운영자가(또는 돌아가며) **주간 3문제**를 공지합니다. (Issue/README/노션 등)
...
### 5) 문제 선정 규칙
- (선택 1) 운영자가 주간 2 ~ 3문제 선정
- (선택 2) 멤버가 돌아가며 1문제씩 추천 → 2 ~ 3문제 확정
